...
if app_id and app_secret:
    cfg = {
        "apps": [{
            ...
            "brand": "feishu",
            "defaultAs": "user",
            "users": [{"userOpenId": os.environ.get("FEISHU_USER_OPEN_ID",""), "userName": "NovelFactory"}]
        }]
    }
    ...
    print("lark-cli config initialized (defaultAs=user, drive use --as user, docs use --as bot)")
else:
    print("LARK_APP_ID / LARK_APP_SECRET not set, skipping lark-cli init")
