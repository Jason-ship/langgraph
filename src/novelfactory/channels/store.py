"""ChannelStore — persists IM chat-to-thread mappings.

Migrated from DeerFlow app/channels/store.py.
"""
...
class ChannelStore:
    """JSON-file-backed store that maps IM conversations to threads.
    ...
    def __init__(self, path: str | Path | None = None) -> None:
        if path is None:
            path = Path(".novelfactory") / "channels" / "store.json"
