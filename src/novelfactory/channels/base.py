...
Migrated from DeerFlow app/channels/base.py.
"""
...
from novelfactory.channels.commands import extract_connect_code
...
class Channel(ABC):
    ...
    async def receive_file(self, msg: InboundMessage, thread_id: str, *, user_id: str | None = None) -> InboundMessage:
        """Optionally process and materialize inbound file attachments.

        By default, this method does nothing and simply returns the original message.
        Subclasses (e.g. FeishuChannel) may override this to download files.
        """
        del user_id
        return msg