...
CHAPTER_MIN_WORD_COUNT = 1500  # 同步 settings.py CHAPTER_MIN_WORD_COUNT（权威来源在 settings）
...
COMPRESS_KEEP_MESSAGES = 5  # 压缩保留最近消息数（Supervisor 消息压缩）
...
EMBEDDING_DIMS_DEFAULT = 768  # Qwen3-Embedding-0.6B 默认维度（与 settings.EMBEDDING_DIMS 对齐）
